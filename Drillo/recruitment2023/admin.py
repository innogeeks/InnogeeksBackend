...
class recruitmentsAdmin(admin.ModelAdmin):
    model = recruitments
    fields = ['name', 'email_personal', 'email_kiet', 'library_id', 'contact_no', 'day_scholar_hosteller', 'gender', 'branch', 'payment_mode', 'desk', 'date', 'payment_status']
    ...
    search_fields = ('email_personal', 'email_kiet', 'name', 'contact_no', 'library_id')
